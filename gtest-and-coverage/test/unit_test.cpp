...
TEST_F(UtilityTest, ArithmeticCalculationDouble) {
    ...
    EXPECT_EQ(util.ArithmeticCalculation(MINUS, 2.0, 1.0), 1.0);
    EXPECT_EQ(util.ArithmeticCalculation(MULTIPLE, 3.0, 3.0), 9.0);
    EXPECT_EQ(util.ArithmeticCalculation(DIVIDE, 10.0, 2.0), 5.0);
    EXPECT_GT(util.ArithmeticCalculation(DIVIDE, 10.0, 0.0), 999999999);
}
